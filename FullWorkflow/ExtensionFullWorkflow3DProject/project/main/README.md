...
2. Install the extension in the CAM system settings window, Extensions tab by specifying the file **bin/Debug/FullWorkflow3DProject.settings.json**.
3. In the utilities menu, select the "**Create full 3D project**" item. A new project will be created.