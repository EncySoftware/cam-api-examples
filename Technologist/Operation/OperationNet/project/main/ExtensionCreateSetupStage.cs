...
/// </summary>
internal class ExtensionCreateSetupStage : IExtension, IExtensionUtility
{
    /// <inheritdoc />
    ...
    public void Run(IExtensionUtilityContext context, out TResultStatus resultStatus)
    {
        ...
        try
        {
            ...
            //create setup stage
            using var setupStageCom = technologistCom.InvokeAndWrap(technologist =>
                technologist.CreateSetupStage(out var resultStatus));
            if (resultStatus.Code == TResultStatusCode.rsError)
                throw new Exception(resultStatus.Description);
