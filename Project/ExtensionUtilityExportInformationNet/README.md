...
The example uses the EncySoftware.CAMAPI.Sdk.Net NuGet package. The optional commented references use **CAMPath** to locate the installed ENCY **Bin64** folder.
