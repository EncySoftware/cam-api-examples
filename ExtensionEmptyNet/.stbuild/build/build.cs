...
public class Build : NukeBuild
{
    ...
    public readonly string VariantName = "Debug";
    ...
    {
        BuildInfo.RunParams[RunInfo.Variant] = VariantName;
        ...
        var settings = new SettingsObject
        {
            ...
            Variants = new VariantList
            {
                new()
                {
                    ...
                    {
                        [Variant.NodeConfig] = "Debug"
                    },
                    Platforms = new Dictionary<string, string>
                    {
                        [Variant.NodePlatform] = "AnyCPU"
                    }
                },
                new()
                {
    ...
    private Target Compile => _ => _
        .Executes(() =>
        {
            _buildSpace.Projects.Compile(VariantName, true);
        });
    ...
    private Target Clean => _ => _
        .Executes(() =>
        {
            _buildSpace.Projects.Clean(VariantName);
        });
    ...
    private Target Pack => _ => _
        ...
        .Executes(() =>
        {
            foreach (var project in _buildSpace.Projects)
            {
                ...
                var dllPath = project.GetBuildResultPath(VariantName, "dll")
