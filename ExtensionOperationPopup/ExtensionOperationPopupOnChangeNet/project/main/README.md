# ExtensionOperationPopupOnChangeNet usage example

This example demonstrates how to create an extension that will go to the entry point when opening the **Operation pop-up** menu after changing it in the CAM system.
