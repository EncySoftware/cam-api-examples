# ExtensionGlobal usage example

This example demonstrates how to create extension that will show entry point on initializing / finalizing in the CAM system.
