# AddinImportObjNet usage example

This example demonstrates how to create addin which will allow you To import files in the **.obj** format via the **Import** button in the ENCY.
