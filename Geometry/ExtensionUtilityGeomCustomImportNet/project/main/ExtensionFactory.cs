using ExtensionUtilityGeomCustomImportNet;
...
public class ExtensionFactory : IExtensionFactory
{
    ...
    public IExtension? Create(string extensionIdent, out TResultStatus ret)
    {
        try
        {
            ...
            {
                "Extension.Utility.Geometry.Importer.Custom.Vertexes.Net" => new ExtensionImportVertex(),
                "Extension.Utility.Geometry.Importer.Custom.Meshes.Net" => new ExtensionImportMesh(),
                "Extension.Utility.Geometry.Importer.Custom.Curves.Net" => new ExtensionImportCurve(),
