...
public class ExtensionFactory : IExtensionFactory
{
    ...
    public IExtension? Create(string extensionIdent, out TResultStatus resultStatus)
    {
        try
        {
            ...
            {
                case "MountingPlateSketchExample":
                    return new CadSketchDrawingNet.MountingPlateSketchExample();
                case "FlangeGasketSketchExample":
                    return new CadSketchDrawingNet.FlangeGasketSketchExample();
                default:
