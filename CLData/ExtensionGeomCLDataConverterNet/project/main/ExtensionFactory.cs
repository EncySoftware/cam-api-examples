...
using ExtensionGeomCLDataConverterNet;
...
public class ExtensionFactory : IExtensionFactory
{
    ...
    public IExtension? Create(string extensionIdent, out TResultStatus ret)
    {
        ...
        {
            ret = default;
            if (extensionIdent.Equals("Extension.GeomCLDataConverter.Simple.Net", StringComparison.OrdinalIgnoreCase))
                return new ExtensionGeomClDataConverter();
